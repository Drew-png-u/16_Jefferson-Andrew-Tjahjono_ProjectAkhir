            ...
            <fieldset>
                <table>
                    <tr>
                        ...
                        <td><input type="text" name="nama" placeholder="Full-Name" id=""></td>
                    </tr>

                    <tr>
                        <td><label for=""> Username </label></td>

                        <td><input type="text" name="username" placeholder="Username" id=""></td>
                    </tr>

                    <tr>
                        <td><label for=""> Age </label></td>

                        <td><input type="number" name="age" placeholder="Age" id=""></td>
                    </tr>

                    <tr>
                        <td><label for=""> E-mail </label></td>

                        <td><input type="text" name="email" placeholder="E-mail" id=""></td>
                    </tr>
